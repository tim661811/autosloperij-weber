...
Owner answers landed 2026-06-12 (via Tim's sister-in-law) and are processed into the site: pickup region around Eindhoven, direct payment, one week parts warranty, brand focus (Peugeot/Citroën/Renault/VW/Seat/Fiat/Japanese, no BMW/Mercedes), email j_weber@hetnet.nl confirmed and on the contact page, NO ARN/Stiba (only RDW-erkend, now on the demontage page) plus Onderdelenlijn.nl affiliation (linked on the onderdelen page), the real story (Johan Weber, took over at 18, Spaarpot 114 since 1986, sharp prices) on over-ons. Six real photos placed: aerial hero, parts warehouse, dismantling workshop, transporter (auto-verkopen, portrait crop), entrance/building (home teaser + over-ons), warehouse interior (over-ons). Old sign discrepancies still to confirm: weekday closing 17:00 vs the old sign's 17:30, and whether mobile 06-53 37 45 35 is still in use (for sign/cards).

- Remaining owner items: domain choice, logo/house style (or keep the JW wordmark), optional balie/intake and team photos (slots fall back gracefully), sign + business card production after the domain is registered (PDF in drukwerk/).
- Saturday hours are settled (Tim, 2026-06-12): definitively closed; the old Sa 09:00-13:00 directory listing and the old facade sign are outdated.

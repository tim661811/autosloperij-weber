...
## Open items
- Phase 2 only: real photos (placeholder slots are ready), domain candidates (autosloperijweber.nl, sloperijweber.nl, weberautodemontage.nl), owner checklist in the spec plus: confirm email address and ARN/SGS certifications (found in public directories, strong trust signals for the demontage page). Saturday hours are settled (Tim, 2026-06-12): definitively closed on Saturdays; the old Sa 09:00-13:00 directory listing is outdated.
